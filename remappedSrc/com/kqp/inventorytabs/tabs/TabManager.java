...
public class TabManager {
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        if (button == 0) {
            ...
            // Check back button
            if (new Rectangle(x - TabRenderer.BUTTON_WIDTH - 4 + ((TabRenderingHints) currentScreen).getTopRowXOffset(),
                    y - 16, TabRenderer.BUTTON_WIDTH,
            ...
            if (new Rectangle(x + guiWidth + 4 + ((TabRenderingHints) currentScreen).getTopRowXOffset(), y - 16,
                    TabRenderer.BUTTON_WIDTH, TabRenderer.BUTTON_HEIGHT)
    ...
    public void restoreCursorStack(ClientPlayerInteractionManager manager, ClientPlayerEntity player,
        ...
        if (handler != null) {
            ...
            if (prevCursorStack != null && !prevCursorStack.isEmpty()) {
                ...
                if (this.prevCursorStackSlot != -1 && client.interactionManager != null) {
                    ...
                    handler.getSlotIndex(client.player.getInventory(), this.prevCursorStackSlot)
                            .ifPresent((screenSlot) -> {
